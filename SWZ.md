...
- Projektant UI
  ...
  - Krzysztof Jurkowski
  - Filip Sosnowski
  - Szymon Rogodziński *- 9.3 Raport z pracy nad widokami GUI*
  - Julia Owczarczyk
  - Jakub Wysocki
  - Karol Zalewski
  - Angelina Sudenkova
...
**Projektancji UI** mieli za zdanie wykonać projekty widoków umiesczone w Figmie oraz w odzielnej dokumentacji. Dodatkowo **Mateusz Sobol** oraz **Szymon Ochnio** opracowali prototyp działania aplikacji również w Figmie.
...
- Analitycy
  - Igor Kędzierewski *- 9.2 Nawigacja pomiędzy poszczególnymi widokami*
  - Wojtek Szade
  - Tymoteusz Gryszkalis *- 9.2 Nawigacja pomiędzy poszczególnymi widokami*
...
### 9.2 Nawigacja pomiędzy poszczególnymi widokami
#### Strona logowania:
...
### 9.3 Raport z pracy nad widokami GUI
